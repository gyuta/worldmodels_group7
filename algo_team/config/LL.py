...
config = Config()
config.seed = 1
config.environment = gym.make("LunarLanderContinuous-v2")
config.num_episodes_to_run = 10 #1000
config.file_to_save_data_results = "data/LL.pkl"
config.file_to_save_results_graph = "data/LL.png"
config.show_solution_score = False
config.visualise_individual_results = False
config.visualise_overall_agent_results = True
config.standard_deviation_results = 1.0
config.runs_per_agent = 1 # 3
...
config.hyperparameters = {
    ...
    "DIAYN": {
        ...
        "num_skills": 10,
        "num_unsupservised_episodes": 5 #500
    }
}
